...
namespace PrintApp
{
    ...
    public class HttpProcessor
    {
        ...
        {
            Console.WriteLine("===http_url======="+ http_url); 
        ...
        public void handlePOSTRequest()
        {
            ...
            try
            {
                ...
                {
                    //   content_len =(int) (this.inputStream).Length;
                    ...
                    while (to_read > 0)
                    {
                        ...
                        to_read -= numread;
                        Console.WriteLine("------to_read-------" + to_read + "===numread===" + numread);
                ...
                {
                    this.writeSuccess("application/json");

                    Response res = new Response();
                    res.stauts = ResStatusCode.Length.ToString();
                    res.desc = "请设置Content-Length值";
